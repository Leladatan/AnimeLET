...
export const animeData: IAnimeItem[] = [
    ...
    {
        id: 5,
        title: "Masters of the Sword Online: Progressive Aria in a Starless Night",
    ...
    {
        id: 12,
        title: "The peach boy from the other shore",
    ...
    {
        id: 13,
        title: "Welcome to the class of excellence",
        ...
        genre: ["", "Drama", "Everyday life", "Psychological", "School"],
        rate: 9.6,
        age: "14+",
    ...
    {
        id: 16,
        title: "Yes, I'm a spider, so what?",
    ...
    //17
    {
        ...
        genre: ["", "Demons", "Comedy", "Everyday life", "Adventures", "Fantasy", "School"],
        rate: 7.0,
        age: "0+",
    ...
    {
        id: 18,
        title: "An unrecognized demon Lord by the school",
    ...
    //19
    {
        ...
        genre: ["", "Drama", "Comedy", "Everyday life", "Romance", "School"],
        rate: 8.0,
        age: "14+",
