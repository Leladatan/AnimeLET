...
export const animeData: IAnimeItem[] = [
    ...
    //22
    {
        ...
        genre: ["", "Комедия", "Романтика", "Сверхъестественное", "Школа"],
        rate: 9.3,
        age: "14+",
        year: 2018,
    ...
    //23
    {
        ...
        genre: ["", "Драма", "Музыка", "Романтика", "Сёнэн", "Школа"],
        rate: 9.2,
        age: "14+",
        year: 2014,
    ...
    //24
    {
        ...
        genre: ["", "Комедия", "Приключения", "Сверхъестественное", "Сёнэн", "Экшен"],
        rate: 8.9,
        age: "14+",
        year: 2014,
    ...
    //26
    {
        ...
        genre: ["", "Детектив", "Психологическое", "Сверхъестественное", "Сэйнэн"],
        rate: 8.0,
        age: "14+",
        year: 2016,
    ...
    //27
    {
        ...
        genre: ["", "Комедия", "Повседневность", "Сэйнэн"],
        rate: 9.5,
        age: "14+",
        year: 2018,
    ...
    //28
    {
        ...
        genre: ["", "Безумие", "Драма", "Меха", "Психологическое", "Фантастика", "Экшен"],
        rate: 9.0,
        age: "14+",
        year: 1995,
    ...
    //29
    {
        ...
        description: "",
        genre: ["", "Гарем", "Комедия", "Меха", "Романтика", "Фантастика", "Школа"],
        rate: 9.8,
        age: "16+",
        year: 2022,
    ...
    //31
    {
        ...
        genre: ["", "Драма", "Комедия", "Приключения", "Романтика", "Сэйнэн", "Фэнтези", "Экшен"],
        rate: 9.3,
        age: "14+",
        year: 2019,
    ...
    //32
    {
        ...
        genre: ["", "Драма", "Приключения", "Фэнтези", "Экшен"],
        rate: 7.7,
        age: "14+",
        year: 2022,
    ...
    //33
    {
        ...
        genre: ["", "Боевые искусства", "Комедия", "Приключения", "Сёнэн", "Супер сила", "Экшен"],
        rate: 9.2,
        age: "16+",
        year: 2002,
    ...
    //34
    {
        ...
        genre: ["", "Военное", "Меха", "Супер сила", "Фантастика", "Школа", "Экшен"],
        rate: 8.0,
        age: "18+",
        year: 2006,
    ...
    //36
    {
        ...
        description: "text",
        genre: ["","Демоны", "Исторический", "Сверхъестественное", "Сёнэн", "Экшен"],
        rate: 9.6,
        age: "18+",
        year: 2021,
    ...
    //38
    {
        ...
        genre: ["", "Военное", "Драма", "Меха", "Супер сила", "Фантастика", "Экшен"],
        rate: 9.5,
        age: "18+",
        year: 2008,
    ...
    //40
    {
        ...
        genre: ["", "Комедия", "Психологическое", "Романтика", "Сэйнэн", "Школа"],
        rate: 9.1,
        age: "16+",
        year: 2019,
